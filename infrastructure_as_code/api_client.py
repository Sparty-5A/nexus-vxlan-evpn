...
class NDFCClient:
    ...
    def login(self) -> None:
        ...
        response = self.client.post(
            f"{self.url}/login", json={"userName": self.username, "userPasswd": self.password, "domain": "local"}
        )
    ...
    def create_network(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Create network"""
        fabric = payload["fabric"]
        return self.post(f"/appcenter/cisco/ndfc/api/v1/lan-fabric/rest/top-down/fabrics/{fabric}/networks", json=payload)
